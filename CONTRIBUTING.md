# Contributing to SEQUENTICHAIN

Thank you for your interest in contributing to **SEQUENTICHAIN ($SQX)** — part of the [AXIOLEDGER](https://github.com/axioledger) ecosystem.
...
cd <repo>
git remote add upstream https://github.com/sequentichain/<repo>.git
```
